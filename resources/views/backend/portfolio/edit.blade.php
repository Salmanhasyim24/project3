    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" method="post" action="{{ route('update.portfolio', $portfolio->id) }}"
                    enctype="multipart/form-data">
                    @csrf

                    <input type="hidden" name="id" value="{{ $portfolio->id }}">
                    <input type="hidden" name="image" value="{{ $portfolio->image }}">
                                ...
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" value="{{ old('name', $portfolio->name) }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="mytextarea" class="form-control @error('description') is-invalid @enderror" name="description"
                                            rows="5" placeholder="Masukkan Konten Post">{{ old('description', $portfolio->description) }}</textarea>
                                    ...
                                    <div class="col-sm-12 text-secondary my-3">
                                        <img id="showImage"
                                            src="{{ !empty('storage/upload/portfolio/' . $portfolio->image) ? asset('storage/upload/portfolio/' . $portfolio->image) : asset('image/no_image.jpg') }}"
