    ...
    <ul class="metismenu" id="menu">
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Home Slide</div>
            </a>
            <ul>
                <li> <a href="{{ route('banner') }}"><i class="bx bx-right-arrow-alt"></i>All HomeSlide</a>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="#"><i class="bx bx-right-arrow-alt"></i>All Portofolio</a>
                </li>
            </ul>
        </li>
        <li>
